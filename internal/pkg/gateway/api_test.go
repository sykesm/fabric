...
func TestGateway(t *testing.T) {
	...
	setup := func(t *testing.T, tt *testDef) (*Server, *mocks.EndorserClient, context.Context, *mocks.Discovery) {
		...
		server := CreateServer(localEndorser, disc, &commitmock.NotificationSupplier{}, "localhost:7051", "msp1", options)
...
func TestNilArgs(t *testing.T) {
	server := CreateServer(&mocks.EndorserClient{}, &mocks.Discovery{}, &commitmock.NotificationSupplier{}, "localhost:7051", "msp1", config.GetOptions(viper.New()))
